...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lunarcalendar-ext-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15060&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lunarcalendar-ext-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lunarcalendar-ext` can be installed with:

```
conda install lunarcalendar-ext
```

It is possible to list all of the versions of `lunarcalendar-ext` available on your platform with:
